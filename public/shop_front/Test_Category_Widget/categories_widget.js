   ...
   //Parse_array_groups_Level 2
    this.parse_groups = function(widget_object,html_object,type_data)
    {
        for(var group in type_data)
        {
            ...
            //create_group_head
            var group_head = widget_object.create_group_head(widget_object,type_data.groups[group]);

            //creare_group_body
            var group_body = widget_object.create_group_body(widget_object,type_data.groups[group]);
