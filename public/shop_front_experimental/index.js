...
function Check_Storage()
{
    try
    {
        ...
        console.log(window.localStorage['category_widget_arrayOfUnchecked ']);
        console.log(window.localStorage['category_widget_selected_type']);
        console.log(window.localStorage['category_widget_categories_data']);
        console.log(window.localStorage['catalog_object_categories']);
        console.log(JSON.parse(window.localStorage['catalog_object_items']));
        console.log(JSON.parse(window.localStorage['catalog_object_filtered_items']));
        console.log(JSON.parse(window.localStorage['cart_object_cart_items']));
        console.log(JSON.parse(window.localStorage['cart_object_cart_sum']));
        console.log(JSON.parse(window.localStorage['cart_object_cart_item_id_counter ']));
        console.log(JSON.parse(window.localStorage['cart_object_cart_template']));


        console.log(JSON.parse(window.localStorage['category_widget_arrayOfUnchecked ']));
        console.log(JSON.parse(window.localStorage['category_widget_selected_type']));
        console.log(JSON.parse(window.localStorage['category_widget_categories_data']));
        console.log(JSON.parse(window.localStorage['catalog_object_categories']));
        console.log(JSON.parse(window.localStorage['catalog_object_items']));
        console.log(JSON.parse(window.localStorage['catalog_object_filtered_items']));
        console.log(JSON.parse(window.localStorage['cart_object_cart_items']));
        console.log(JSON.parse(window.localStorage['cart_object_cart_sum']));
