...
function shopping_cart()
 {
   ...
   this.cart_widget_html = "<div class = 'col s3 m3 l3 3' class = 'cart_widget'><div><i class = ' material-icons' style = 'background:#38993C; border-radius:999px;padding:30%;:90px; margin-top:20%'>shopping_cart</i></div></div><div class = 'col s8 m8 l8 8'><p style = 'margin-bottom:0px;margin-top:5%;font-size:140%'> корзина </p><hr style = 'margin:0px'><p id = 'shopping_cart_price' style = 'font-size:110% ; margin-top:0px; margin-bottom:0px; margin-left:5%'>корзина пуста</p></div>'";
